...
const HeroSlider: React.FC = () => {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-black">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-2 md:left-6 top-1/2 transform -translate-y-1/2 z-20 bg-gray-800 bg-opacity-80 hover:bg-opacity-100 rounded-full transition-all duration-300 group min-w-[44px] min-h-[44px] flex items-center justify-center"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-2 md:right-6 top-1/2 transform -translate-y-1/2 z-20 bg-gray-800 bg-opacity-80 hover:bg-opacity-100 rounded-full transition-all duration-300 group min-w-[44px] min-h-[44px] flex items-center justify-center"
